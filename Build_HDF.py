...
def Build_HDF(docAll, docVis1, docVis2 ):
    ...
    for spl in splits:
        ...
        Images_Dictionary={}
        Image_vectors_dic={}
        Images_Dictionary, Image_vectors_dic=Extraxt_Vector(pascal_file)
        ...
        for count, im in enumerate(All_Dict.keys()):
            ...
            dset_edis = container.create_dataset("eng_dis", (50,), dtype=dt) #for each image we have in pascal 50s 50 descriptions
            dset_sent_vec=container.create_dataset("sent_vec", (50,4800), dtype='float32') # the vectors representing the sentences
            dset_vis1 = container.create_dataset("vis_feats1", (4096,), dtype='float32') #the dimension of the vector of each image ---change to auto
            dset_vis2 = container.create_dataset("vis_feats2", (100352,), dtype='float32')
